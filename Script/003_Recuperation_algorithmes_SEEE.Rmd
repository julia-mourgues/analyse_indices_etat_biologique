...
Ce script permet de récupérer les algorithmes du SEEE et de calculer les indices d'état biologiques ainsi que leurs métriques.
...
Les données sont caractérisées par un niveau de conformité. Ici nous choisissons de travailler sur les données "correctes" et "non définissables", qui correspondent aux code "1" et "0".
